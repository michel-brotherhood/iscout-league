  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        helvetica: ['Sora', 'system-ui', 'sans-serif'],
        'helvetica-neue': ['Sora', 'system-ui', 'sans-serif'],
      },
      colors: {
        ...
        iscout: {
          dark: "hsl(var(--iscout-dark))",
          darker: "hsl(var(--iscout-darker))",
          cyan: "hsl(var(--iscout-cyan))",
          blue: "hsl(var(--iscout-blue))",
          glow: "hsl(var(--iscout-glow))",
          lime: "hsl(var(--iscout-lime))",
          green: "hsl(var(--iscout-green))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
